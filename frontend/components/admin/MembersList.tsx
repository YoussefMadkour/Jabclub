      ...
      <div className="bg-[#16161a] rounded-lg shadow-md p-6 border border-[#26262B]">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-400 mt-1">Manage and view all members</p>
          </div>
        </div>
      </div>
              ...
              <tbody className="bg-[#16161a] divide-y divide-[#26262B]">
                {members.map((member) => (
                  <tr key={member.id} className="hover:bg-white/5">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`px-2 py-1 text-xs rounded-full ${ member.isActive ? 'bg-green-100 text-green-800' : 'bg-[#1f1f23] text-gray-100' }`}
                      >
                    ...
                    <td className="px-6 py-4">
                      {member.activePackage ? (
                        ...
                        <span className="text-sm text-gray-400">No active package</span>
                      )}
                    </td>
                    <td className="px-6 py-4">
      ...
      {showEditModal && selectedMember && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-[#16161a] rounded-lg p-6 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto border border-[#26262B]">
            <h2 className="text-xl font-bold mb-4 text-gray-300">Edit Member</h2>
