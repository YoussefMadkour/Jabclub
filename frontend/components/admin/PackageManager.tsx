            ...
            >
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                  ...
                  <span className="text-sm font-semibold text-[#000000]">{pkg.purchaseCount}</span>
                </div>
                        ...
                        <div key={lp.locationId} className="flex items-center justify-between text-xs">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="text-[#000000] hover:text-gray-600 text-xs"
                            >
                              Edit
                            </button>
                            <button
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              <div className="text-sm space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-[#000000]">{selectedPackage.purchaseCount}</span>
                </div>
              </div>
            </div>
